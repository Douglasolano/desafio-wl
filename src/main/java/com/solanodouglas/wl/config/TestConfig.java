...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Colaborador colaborador2 = new Colaborador(null, "Lucia", "56641672034");
		
		Cafe cafe1 = new Cafe(null, "Salgadinhos", colaborador1);
		Cafe cafe2 = new Cafe(null, "Bolinho de chuva", colaborador2);
		Cafe cafe3 = new Cafe(null, "Bolo de chocolate", colaborador1);
		Cafe cafe4 = new Cafe(null, "Bolinho", null);
		
		colaboradorRepository.saveAll(Arrays.asList(colaborador1, colaborador2));
		cafeRepository.saveAll(Arrays.asList(cafe1, cafe2, cafe3, cafe4));
	}
}
